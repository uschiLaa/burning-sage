...
\textcolor{blue}{Common solutions to overplotting include transparency and binned or density displays [@chang]. These are designed to tackle large sample size, not dimension reduction problems. A low-dimensional projection represented as a scatterplot, binned plot, or contour plot, will still suffer from data piling and reduced resolution near the center of the projection. These approaches can be still be applied after the transformation, especially for large sample sizes.}
