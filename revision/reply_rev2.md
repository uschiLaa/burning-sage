...
**Response**: We prefer to include the reference to acknowledge the related work on sparsity, but have rephrased the corresponding sentence to point out that it is not directly relevant to the rest of the paper.
...
**Response**: We have updated the reference. While the paper is unpublished, the pdf is available via the CiteSeerX DOI.
...
**Response**: We decided to add an original reference to Carr et al. (1987) followed by the reference to Section 5.5 of Chang (2018) as an accessible and practical overview on the topic.
...
**Response**: We have changed this to full journal names everywhere.
...
**Response**: We appreciate this point of view, and do also think this is interesting but don't know what to do with it for this paper. We think it is best left for us all to ponder on for now.
