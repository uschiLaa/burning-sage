...
the curse of dimensionality in high dimensional projections, and have shown its utility in applications to analysis tasks found in the natural sciences and machine learning. Our case studies highlight that sage display can reduce the effects of data piling. We showed in the sketches example, that our new display decreases the number of overlapping points between classes and provides
