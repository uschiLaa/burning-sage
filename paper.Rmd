...
For the sage display tuning is often required to avoid bunching points in the 
visualisation, especially if the projection is dense in the center of the 
...
visualisation. Our parameter tuning example highlights this: the sage display is 
...
to the edge of the hypersphere as $\gamma$ and $R$ are changed. Given
that the display is quick to compute, being able to modify these parameters in 
real time with an interactive interface would be beneficial.  Currently, the 
