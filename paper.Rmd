...
XXX is pdfsense example of search task? maybe understanding structures across multiple dimensions instead?
In the pdfsense example, by zooming in on the 
points in the blue cluster we saw how they were present in all directions of the
parameter space, which was difficult to see with the regular tour.
