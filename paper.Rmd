...
```{r mouse-cluster, fig.cap = "Selected frames from using a tour of the mouse data with the default tour display (top), and the sage display with $\\gamma=3$ (bottom)"}
library(cowplot)
dir <- "pngs/"
...
```{r sketches, fig.cap = "Selected frames  of the tour run on the sketches data using the default tour display (top), and using the default sage display (bottom)."}
...
```{r pdfsense, fig.cap = "Selected frames of the tour run on the pdfsense data using the default tour display (top), and using the sage display with $R=10$ (bottom)"}
