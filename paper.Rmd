...
and their relative orientation. We learned that the highlighted 
The single cell RNA-seq case study uncovered clusters that were originally obscured by data piling; 

as we saw in our single cell example. Our parameter tuning example highlights that the sage display is linear up to a given effective dimension. As a result, the sage display provides interpretable visualisations while preserving global structure in the high dimensional space, as highlighted in the particle physics example.
...
Add note on interactivity to tuning paragraph. Add a paragraph on applications, correlation
